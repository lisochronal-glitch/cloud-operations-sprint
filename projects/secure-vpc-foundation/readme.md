...
- [Private application route table with NAT Gateway and S3 Gateway Endpoint routes](./evidence/project2-private-db-route-table-local-only.png)
...
- [Application security group allowing HTTP from the ALB security group](./evidence/project2-db-sg-source-app-sg.png)
