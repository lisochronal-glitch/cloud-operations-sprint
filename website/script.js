const translations = {
  en: {
    ...
    "hero.primaryButton": "View Projects",
    ...
    "skills.opsText": "Linux, AWS CLI, IAM users/roles/policies, IAM Identity Center permission sets, least-privilege design, service health verification, logs, deployment validation, troubleshooting",
  ...
  ja: {
    ...
    "skills.opsTitle": "運用",
    "skills.opsText": "Linux、AWS CLI、IAMユーザー/ロール/ポリシー、IAM Identity Centerの許可セット、最小権限設計、サービスヘルス確認、ログ、デプロイ検証、トラブルシューティング",
    "skills.iacTitle": "Infrastructure as Code",
