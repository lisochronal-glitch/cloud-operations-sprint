const translations = {
  en: {
    ...
    "skills.opsText": "Linux, AWS CLI, IAM Identity Center, service health verification, logs, deployment validation, troubleshooting",
  ...
  ja: {
    ...
    "skills.opsTitle": "運用",
    "skills.opsText": "Linux、AWS CLI、IAM Identity Center、サービスヘルス確認、ログ、デプロイ検証、トラブルシューティング",
    "skills.iacTitle": "Infrastructure as Code",
