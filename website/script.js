const translations = {
  en: {
    ...
    "projects.project2Title": "VPC / Network Security Lab",
    "projects.project2Text": "Planned hands-on lab focused on VPC structure, subnets, route tables, internet access, security groups, connectivity testing, and troubleshooting.",
 ...
 "project.label": "CURRENT PROJECT",
    ...
    "skills.cloudText": "S3, CloudFront, Route 53, API Gateway, Lambda, DynamoDB, IAM, CloudWatch",
  ...
  ja: {
    ...
    "projects.project2Title": "VPC / ネットワークセキュリティラボ",
    "projects.project2Text": "VPC構成、サブネット、ルートテーブル、インターネット接続、セキュリティグループ、疎通確認、トラブルシューティングに焦点を当てた実践ラボの予定です。",
