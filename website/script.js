const translations = {
  en: {
    ...
    "project.staticText": "HTML/CSS/JavaScript hosted on Amazon S3",
    "project.cdnLabel": "CDN:",
    "project.cdnText": "CloudFront distribution for secure global delivery",
    ...
    "project.databaseText": "DynamoDB visitor counter and project metadata",
    ...
    "evidence.heading": "What this project is designed to demonstrate",
  ...
  ja: {
    ...
    "project.databaseText": "DynamoDBによる訪問者カウンターとプロジェクトメタデータ",
